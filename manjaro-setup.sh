...
pacman_install() {
    ...
    PACMAN_PACKAGES="openssh bat docker docker-compose curl mongodb mongodb-tools keepassxc easytag xclip xf86-input-synaptics fzf ruby sublime-text neovim cmake freetype2 fontconfig pkg-config make rustup"
