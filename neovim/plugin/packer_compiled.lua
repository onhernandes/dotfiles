...
vim.cmd [[au FileType json ++once lua require("packer.load")({'leshill-vim-json', 'vim-gotofile', 'json-formatter.vim'}, { ft = "json" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'yajs.vim', 'nvim-treesitter', 'typescript-vim', 'vim-gotofile', 'vim-js-pretty-template', 'vim-jsdoc', 'vim-jsx-pretty', 'yats.vim', 'es.next.syntax.vim', 'vim-react-snippets', 'vim-node'}, { ft = "typescript" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'vim-gotofile', 'emmet-vim', 'vim-jsdoc', 'vim-jsx-pretty'}, { ft = "jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'vim-gotofile', 'emmet-vim', 'vim-jsx-pretty'}, { ft = "tsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'yajs.vim', 'nvim-treesitter', 'vim-gotofile', 'vim-js-pretty-template', 'vim-jsdoc', 'vim-jsx-pretty', 'es.next.syntax.vim', 'vim-react-snippets', 'vim-node'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascriptreact ++once lua require("packer.load")({'nvim-treesitter'}, { ft = "javascriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-treesitter', 'vim-css-color', 'emmet-vim', 'vim-jsdoc', 'es.next.syntax.vim', 'vim-jsx-typescript'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
